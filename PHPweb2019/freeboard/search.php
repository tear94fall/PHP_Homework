        ...
        <td>
            ...
            <table border=0 cellspacing=0 cellpdding=0 width='100%' class="txt">
                ...
                for ($i=$start; $i<$start+$scale && $i < $total_record; $i++)
                {
                    ...
                    // 레코드 화면에 출력하기
                    echo "<tr height=25><td align=center>$row[num]</td><td><img src='img/record_id.gif' border=0><a href='view.php?num=$row[num]&page=$page'>$row[subject]</a></td><td align=center>$row[name] </td><td align=center>$day</td><td align=center>$row[hit]</td></tr><tr bgcolor='#CCCCCC' height=1> <td colspan='5'></td></tr>";
                }
                ?>
