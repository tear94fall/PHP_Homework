...
if ($userid != "admin")
{
    echo("<script>window.alert('관리자만 수정할 수 있습니다.'); history.go(-1)</script>");
    exit;
}
else {
    ...
    <table border=0 cellspacing=0 cellpdding=0 width='776' align='center'>
        <form name='writeform'action='modify.php?num=<?php echo$num?>&page=<?php echo$page?>'method='post'>
            <tr>
                                    ...
                                    <td align='center' >
                                        <p align='left'>&nbsp; 내용&nbsp;&nbsp;&nbsp;
                                            <textarea style='font-size:9pt;border:1px solid' name='content'
                                                      ...
                                                      cols=74 rows=12 wrap=virtual><?php echo $row['content'] ?></textarea></td>
                                </tr>
                                <tr height=20>
                                    <td></td>
                                </tr>
